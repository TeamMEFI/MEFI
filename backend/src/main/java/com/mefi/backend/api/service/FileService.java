...
public class FileService {
    ...
    /**
     * 파일명을 이용하여 회의록 또는 첨부파일을 삭제하기 위한 메소드
     * @param fileName
     */
    @Transactional
    ...
    /**
     * 특정 회의와 관련된 회의록 및 첨부파일 리스트를 가져오는 메소드
     * @param conferenceId
     * @return
     */
    ...
    public String createProfile(MultipartFile profileImage) throws IOException {
        try{
            ...
            e.printStackTrace();
            throw new IOException("프로필 이미지 업로드에 실패했습니다", e);
        }
    }
